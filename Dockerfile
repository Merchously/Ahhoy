...
COPY --from=builder /app/scripts/seed-reviews.mjs ./scripts/seed-reviews.mjs
...
CMD ["sh", "-c", "export NODE_PATH=$(npm root -g); prisma db push 2>&1; node scripts/seed-admin.mjs 2>&1; node scripts/seed-listings.mjs 2>&1; node scripts/seed-reviews.mjs 2>&1; node server.js"]
